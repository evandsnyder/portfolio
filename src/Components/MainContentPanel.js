    ...
    return (
        <div className='main-content' ref={innerRef}>
            <div className="about-me-header" id="section-about-me">
                ...
                <p>
                    As a current student in <a href="https://www.vertexschool.com/game-development-program">Vertex School's</a> Game Development Program,
                ...
                <p>Outside of work, I like to brew my own beer, peek out at the universe through my telescope, and play boardgames with my fiancé</p>
            </div>
